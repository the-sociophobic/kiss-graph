...
This module is a Sails/Waterline community adapter.  Its goal is to provide a set of declarative interfaces, conventions, and best-practices for integrating with the neo4j database/service.
...
This neo4j adapter is available under the **MIT license**.
